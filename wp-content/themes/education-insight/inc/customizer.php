...
function education_insight_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( new Education_Insight_Customizer_Customcontrol_Section_Heading( $wp_customize, 'education_insight_section_shoppage_heading', array(
		'label'       => esc_html__( 'Shop Page Settings', 'education-insight' ),
		'section'     => 'education_insight_theme_settings',
	...
	$wp_customize->add_control(
		new Education_Insight_Customizer_Customcontrol_Switch(
			...
			array(
				...
				'section'         => 'education_insight_theme_settings',
				'label'           => __( 'Hide Shop Page Sidebar', 'education-insight' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'education-insight' ),
					'off'    => __( 'Off', 'education-insight' ),
				),
	...
	$wp_customize->add_control(
		new Education_Insight_Customizer_Customcontrol_Switch(
			...
			array(
				...
				'section'         => 'education_insight_theme_settings',
				'label'           => __( 'Hide Single Product Page Sidebar', 'education-insight' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'education-insight' ),
					'off'    => __( 'Off', 'education-insight' ),
				),
    ...
    $wp_customize->add_setting( 'education_insight_theme_button_color', array(
  	...
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'education_insight_theme_button_color', array(
	    'description' => __('It will change the complete theme  Buttton color in one click.', 'education-insight'),
			...
			array(
				...
				'choices' => array(
					...
					'two_column' => array(
						...
						'name' => __( 'Two Column', 'education-insight' )
					),
					'three_column' => array(
	...
	$wp_customize->add_control(
		new Education_Insight_Customizer_Customcontrol_Switch(
			...
			array(
				...
				'section'         => 'education_insight_top',
				'label'           => __( 'Check to Hide contact info', 'education-insight' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'education-insight' ),
					'off'    => __( 'Off', 'education-insight' ),
				),
	...
	$wp_customize->add_control('education_insight_call',array(
		...
		'type'    => 'text',
		'active_callback' => 'education_insight_topbar_dropdown',
	...
	$wp_customize->add_setting(
		'education_insight_header_fb_target',
		array(
			'type'                 => 'option',
			'capability'           => 'edit_theme_options',
			'theme_supports'       => '',
	...
	$wp_customize->add_control(
		new Education_Insight_Customizer_Customcontrol_Switch(
			...
			'education_insight_header_fb_target',
			array(
				'settings'        => 'education_insight_header_fb_target',
				'section'         => 'education_insight_urls',
	...
	$wp_customize->add_setting(
		'education_insight_header_pintrest_target',
		array(
			'type'                 => 'option',
			'capability'           => 'edit_theme_options',
			'theme_supports'       => '',
	...
	$wp_customize->add_control(
		new Education_Insight_Customizer_Customcontrol_Switch(
			...
			'education_insight_header_pintrest_target',
			array(
				'settings'        => 'education_insight_header_pintrest_target',
				'section'         => 'education_insight_urls',
				'label'           => __( 'Open link in a new tab', 'education-insight' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'education-insight' ),
	...
	$wp_customize->add_control(
		new Education_Insight_Customizer_Customcontrol_Switch(
			...
			array(
				...
				'section'         => 'education_insight_slider_section',
				'label'           => __( 'Check To Hide Slider', 'education-insight' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'education-insight' ),
					'off'    => __( 'Off', 'education-insight' ),
				),
