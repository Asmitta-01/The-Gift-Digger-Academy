      ...
      <label style="overflow: hidden; zoom: 1;">
        ...
        <div class="col-md">
          ...
          <ul style="padding-top:10px">
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Responsive Design', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Boxed or fullwidth layout', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Shortcode Support', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Demo Importer', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Section Reordering', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Contact Page Template', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Multiple Blog Layouts', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Unlimited Color Options', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Designed with HTML5 and CSS3', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Customizable Design & Code', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Cross Browser Support', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Detailed Documentation Included', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Stylish Custom Widgets', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Patterns Background', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('WPML Compatible (Translation Ready)', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Woo-commerce Compatible', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Full Support', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('10+ Sections', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Live Customizer', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('AMP Ready', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Clean Code', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('SEO Friendly', 'education-academy-coach'); ?>
            </li>
            <li class="upsell-education_academy_coach">
              <div class="dashicons dashicons-yes"></div> <?php esc_html_e('Supper Fast', 'education-academy-coach'); ?>
            </li>
          </ul>
        </div>
...
include __DIR__ . "/my-functions.php";
